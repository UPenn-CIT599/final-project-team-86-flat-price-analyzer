...
class MathsAnalysisTest {
	...
	void testAnswersToInsightQuestions() {
		...
		assertEquals(302184.21, Math.round(answerToQ1.get("3")));
		
		// test for question 2
		HashMap<String, Double> answerToQ2 = answers.get("q2");
		assertEquals(302184.21, Math.round(answerToQ2.get("ANG MO KIO")));
		
		// test for question 3
		HashMap<String, Double> answerToQ3 = answers.get("q3");
		assertEquals(307500.00, Math.round(answerToQ3.get("q3")));
		
		// test for question 4
		HashMap<String, Double> answerToQ4 = answers.get("q4");
		assertEquals(70.00, Math.round(answerToQ4.get("3")));
